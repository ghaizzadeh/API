...
namespace PsdWebProcessApi.Controllers
{
   ...
   public class DoctorController : ControllerBase
   {
      ...
      [HttpGet, Route("DrListDt/{pHspId}/{pType}/{pRecep?}/{pAss?}")]
      public string DrListDt(long pHspId, string pType, int pRecep, int pAss)
      {
         fLoad();
         var vDt = cc.doctor.fDoctorDt(pHspId, pType, pRecep, pAss);
